...
const file_api_v1_ai_service_proto_rawDesc = "" +
	...
	"\tAIService\x12y\n" +
	"\n" +
	"Transcribe\x12\x1f.memos.api.v1.TranscribeRequest\x1a .memos.api.v1.TranscribeResponse\"(\xdaA\x05audio\x82\xd3\xe4\x93\x02\x1a:\x01*\"\x15/api/v1/ai:transcribeB\fZ\n" +
